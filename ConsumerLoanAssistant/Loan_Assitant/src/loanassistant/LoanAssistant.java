...
public LoanAssistant() { // frame constructor 
...
gridConstraints = new GridBagConstraints(); 
gridConstraints.gridx = 3;
gridConstraints.gridy = 1; gridConstraints.gridheight = 4;
...
private void computeButtonActionPerformed(javafx.event.ActionEvent e){
...
private void newLoanButtonActionPerformed(javafx.event.ActionEvent e) { 
...
private void monthsButtonActionPerformed(javafx.event.ActionEvent e) { 
// will compute months 
...
private void paymentButtonActionPerformed(javafx.event.ActionEvent e) {
...
private void exitButtonActionPerformed(javafx.event.ActionEvent e) { 
    System.exit(0);
}
 
private void balanceTextFieldActionPerformed(javafx.event.ActionEvent e) { 
    balanceTextField.transferFocus(); 
}
private void interestTextFieldActionPerformed(javafx.event.ActionEvent e) {
    interestTextField.transferFocus(); 
}
private void monthsTextFieldActionPerformed(javafx.event.ActionEvent e) {
monthsTextField.transferFocus();
}

private void paymentTextFieldActionPerformed(javafx.event.ActionEvent e) { paymentTextField.transferFocus(); }
